...
if(item == "jacket"){
    money -= 40; health+=20; console.log("You bought a jacket");
}else if(item == "candy"){
    money -= 10; console.log("You bought candy");
}else if(item == "paint"){
    money -= 30; console.log("You bought paint");
}else if(item == hammer){
    money -= 70; console.log("You bought a hammer");
}
